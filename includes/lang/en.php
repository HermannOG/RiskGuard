...
return [
    ...
    // Health Monitor
        ...
        'monitor.estres.intro'     => 'Generates real load through a database link so you can see how the indices change when capturing under pressure. Read-only; it leaves the database exactly as it was.',
        'monitor.estres.link'      => 'Database link',
        'monitor.estres.link.otro' => 'Other… (type manually)',
        ...
        'monitor.estres.activo'    => 'Stress active: %d of %d job(s) running. Capture now to see the effect.',
