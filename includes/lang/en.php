...
return [
    ...
    // Health Monitor
        ...
        'monitor.estres.titulo'    => 'Stress test',
        'monitor.estres.intro'     => 'Generates real load (heavy queries across several sessions) so you can see how the indices change when capturing under pressure. By default it stresses this same database (local load); read-only, and it leaves the database exactly as it was.',
        'monitor.estres.origen'      => 'Load source',
        'monitor.estres.origen.local'=> 'Local (this database, no link)',
        'monitor.estres.origen.porlink' => 'Via link:',
        'monitor.estres.link'      => 'Database link',
        'monitor.estres.link.otro' => 'Other database link… (type manually)',
        'monitor.estres.link.manual' => 'Database link name',
        'monitor.estres.link.ninguno' => 'No database links found; type the name manually.',
        'monitor.estres.sesiones'  => 'Sessions',
        'monitor.estres.duracion'  => 'Duration (s)',
        'monitor.estres.activo'    => 'Stress active: %d of %d job(s) running. The charts refresh on their own every 3 s (not saved to history).',
        'monitor.estres.detener'   => 'Stop and clean up',
        'monitor.estres.refrescar' => 'Refresh status',
        'monitor.estres.nota'      => 'Jobs only read (SELECT) through the link and auto-drop; they never modify data.',
        'monitor.estres.error'     => 'Stress error',
        'monitor.estres.envivo'    => 'Live update (every 3 s)',
        'monitor.estres.envivo.on' => 'LIVE',
