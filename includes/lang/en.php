...
return [
    ...
    // Health Monitor
        'monitor.nav.item'          => 'Health Monitor',
        'monitor.instancias.titulo' => 'Monitored instances',
        'monitor.instancias.lead'   => 'Register the databases you want to watch.',
        'monitor.instancias.nombre' => 'Name',
        'monitor.instancias.motor'  => 'Engine',
        'monitor.instancias.host'   => 'Host',
        'monitor.instancias.puerto' => 'Port',
        'monitor.instancias.bd'     => 'Database',
        'monitor.instancias.usuario'=> 'Username',
        'monitor.instancias.password'=> 'Password',
        'monitor.instancias.agregar'=> 'Add instance',
        'monitor.instancias.ver'    => 'View health',
        'monitor.instancias.ok'     => 'Instance added successfully.',
        'monitor.instancias.faltan' => 'Required fields are missing.',

        'monitor.salud.capturar'    => 'Capture now',
        'monitor.salud.sincapturas' => 'No captures yet for this instance. Click "Capture now".',
        'monitor.salud.porque'      => 'Why',
        'monitor.salud.esta_asi'    => 'looks like this',
        'monitor.componente.procesos' => 'Processes',
        'monitor.componente.memoria'  => 'Memory',
        'monitor.componente.archivos' => 'Files',

        'monitor.ayuda.isbd.titulo' => 'ISBD by color',
        'monitor.ayuda.isbd.verde' => 'Overall healthy database, no relevant issues.',
        'monitor.ayuda.isbd.amarillo' => 'Mild warning, at least one area worth watching.',
        'monitor.ayuda.isbd.anaranjado' => 'Degraded health, one or more components need attention soon.',
        'monitor.ayuda.isbd.rojo' => 'Critical state, immediate review recommended.',

        'monitor.ayuda.procesos.titulo' => 'Processes (IP) by color',
        'monitor.ayuda.procesos.verde' => 'Normal process load, no signs of saturation.',
        'monitor.ayuda.procesos.amarillo' => 'Activity above usual, watch the trend.',
        'monitor.ayuda.procesos.anaranjado' => 'Risk of process saturation or blocked sessions.',
        'monitor.ayuda.procesos.rojo' => 'Real saturation: rejected connections or serious locking.',

        'monitor.ayuda.memoria.titulo' => 'Memory (IM) by color',
        'monitor.ayuda.memoria.verde' => 'Healthy memory and cache use, with headroom available.',
        'monitor.ayuda.memoria.amarillo' => 'Memory use above ideal.',
        'monitor.ayuda.memoria.anaranjado' => 'Noticeable memory pressure, performance may start to drop.',
        'monitor.ayuda.memoria.rojo' => 'Memory at its limit, high risk of slowness or failures.',

        'monitor.ayuda.archivos.titulo' => 'Files (IA) by color',
        'monitor.ayuda.archivos.verde' => 'Space and files in good shape, no immediate risk.',
