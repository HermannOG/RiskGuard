...
return [
    ...
    // Monitor de Salud
        ...
        'monitor.estres.titulo'    => 'Prueba de estrés',
        'monitor.estres.intro'     => 'Genera carga real contra un database link para ver cómo cambian los índices al capturar bajo presión. Solo hace lecturas; al terminar deja la base exactamente como estaba.',
        'monitor.estres.link'      => 'Database link',
        'monitor.estres.link.otro' => 'Otro… (escribir a mano)',
        'monitor.estres.link.manual' => 'Nombre del database link',
        'monitor.estres.link.ninguno' => 'No se encontraron database links; escribe el nombre a mano.',
        'monitor.estres.sesiones'  => 'Sesiones',
        'monitor.estres.duracion'  => 'Duración (s)',
        'monitor.estres.activo'    => 'Estrés activo: %d de %d job(s) corriendo. Captura ahora para ver el efecto.',
        'monitor.estres.detener'   => 'Detener y limpiar',
        'monitor.estres.refrescar' => 'Actualizar estado',
        'monitor.estres.nota'      => 'Los jobs solo leen (SELECT) a través del link y se autoeliminan; no modifican datos.',
        'monitor.estres.error'     => 'Error de estrés',
