...
return [
    ...
    // Monitor de Salud
        ...
        'monitor.estres.intro'     => 'Genera carga real (consultas pesadas en varias sesiones) para ver cómo cambian los índices al capturar bajo presión. Por defecto estresa esta misma base (carga local); solo hace lecturas y al terminar deja la base exactamente como estaba.',
        'monitor.estres.origen'      => 'Origen de la carga',
        'monitor.estres.origen.local'=> 'Local (esta base, sin link)',
        'monitor.estres.origen.porlink' => 'Por link:',
        'monitor.estres.link'      => 'Database link',
        'monitor.estres.link.otro' => 'Otro database link… (escribir a mano)',
        ...
        'monitor.estres.activo'    => 'Estrés activo: %d de %d job(s) corriendo. Los gráficos se actualizan solos cada 3 s (no se guarda en el historial).',
        ...
        'monitor.estres.envivo'    => 'Actualizar en vivo (cada 3 s)',
        'monitor.estres.envivo.on' => 'EN VIVO',
